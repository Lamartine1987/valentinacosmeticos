...
export const settingsModule = {
        ...
        try {
            ...
            if (docApi.exists) {
                ...
                if(this.apiSettings.instances.length === 0) {
                    this.apiSettings.instances.push({id: Date.now(), storeId: 'Loja 1', provider: 'zapi', url: '', token: '', active: true});
                }
                ...
                <div class="form-grid">
                    <div class="form-group" style="grid-column: span 2;">
                        ...
                        <select class="api-v-store" required>
                            <option value="Loja 1" ${inst.storeId === 'Loja 1' || inst.storeId === 'matriz' ? 'selected' : ''}>Loja 1</option>
        ...
        try {
            ...
            snapshot.forEach(doc => {
                ...
                if (user.storeId && user.storeId !== 'all') {
                    storeLabel = user.storeId === 'Loja 1' || user.storeId === 'matriz' ? 'Loja 1' : 'Loja 2';
                }
    ...
    openTeamModal(editUser = null) {
        ...
        if (editUser && editUser.id) {
            ...
            if(document.getElementById('t-store')) document.getElementById('t-store').value = editUser.storeId || 'Loja 1';
