...
export const funnelModule = {
    ...
    listenToLeads() {
        ...
        if (this.currentUserProfile.role !== 'admin') {
            const storeId = this.currentUserProfile.storeId || 'Loja 1';
    ...
    renderFunnelBoard() {
        ...
        sortedLeads.forEach(lead => {
            ...
            let storeBadgeId = lead.storeId || 'Loja 1';
            let storeBadgeLabel = storeBadgeId === 'Loja 1' || storeBadgeId === 'matriz' ? 'Loja 1' : 'Loja 2';
...
<div class="wa-bubble-time" style="justify-content: flex-start;">${timeStr}</div></div>`;
    ...
    async sendLeadMessage() {
        ...
        const sourceStore = currentLead ? (currentLead.storeId || 'Loja 1') : 'Loja 1';
